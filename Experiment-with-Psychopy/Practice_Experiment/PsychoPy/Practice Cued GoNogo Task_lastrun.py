...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Harsh\\Downloads\\Experiment\\Practice_Experiment\\Practice Cued GoNogo Task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    imageInstruct = visual.ImageStim(
        ...
        ori=0.0, pos=(0, 0), draggable=False, size=(1.5, 1),
    ...
    fixation = visual.TextStim(win=win, name='fixation',
        text='Welcome to the Practice Experiment!\n\nPressing the SPACEBAR will start the scan.',
        font='NanumSquare',
    ...
    try:
        ...
        info = StreamInfo('PsychoPy', 'Markers', 1, 0, 'string', 'psychopygonogo123')
    ...
    instruction_slide_loop = data.TrialHandler2(
        name='instruction_slide_loop',
        nReps=1.0, 
        method='sequential', 
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('instructions/instruction_slides.xlsx'), 
        seed=None, 
    )
    ...
    for thisInstruction_slide_loop in instruction_slide_loop:
        ...
        instructions = data.Routine(
            name='instructions',
            components=[imageInstruct, buttonNext],
        )
        instructions.status = NOT_STARTED
        continueRoutine = True
        # update component parameters for each repeat
        imageInstruct.setImage(instruct_slide)
        ...
        if isinstance(instruction_slide_loop, data.TrialHandler2) and thisInstruction_slide_loop.thisN != instruction_slide_loop.thisTrial.thisN:
        ...
        while continueRoutine:
            ...
            if buttonNext.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                ...
                win.callOnFlip(buttonNext.buttonClock.reset)
        ...
        routineTimer.reset()
    # completed 1.0 repeats of 'instruction_slide_loop'
    ...
    Blocks = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('blocks/BlockList.xlsx'), 
        seed=None, 
    )
        ...
        for thisTrial in Trials:
            ...
            if StimType == 'Go': # go cue on the condition of presenting the go cue 
                if Key_Resp.corr == 1: # if the answer is correct,
                    fb_color = 'Maroon'
                    fb_msg = "Correct"+"\n"+"Reaction Rate: "+str(int(Key_Resp.rt*1000))+"ms"
                else: # if correct
                    fb_color = 'MediumBlue'
                    fb_msg = "Wrong"
            elif StimType == 'NoGo': # Nogo cue on Nogo cure presentation condition 
                if Key_Resp.corr == 1: # if the answer is correct,
                    fb_color = 'Maroon'
                    fb_msg = "Correct"
                else: # if incorrect
    ...
    TaskEnd = data.Routine(
        name='TaskEnd',
        components=[Thankyou, key_resp_2],
    )
